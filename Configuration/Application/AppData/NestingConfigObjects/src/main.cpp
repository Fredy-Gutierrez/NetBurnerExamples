...
class ThermoGroup : public config_obj
{
   public:
    Thermostat thermo_1{"Thermostat 1"};
    Thermostat thermo_2{"Thermostat 2"};
    ConfigEndMarker;   // No new data members below this line

    ThermoGroup(const char *name, const char *desc = nullptr) : config_obj(name, desc){};
    ThermoGroup(config_obj &owner, const char *name, const char *desc = nullptr) : config_obj(owner, name, desc){};
};
 ...
 */
static ThermoGroup thermoGroup(appdata, "Thermostat Group", "The primary thermostat");

const char *AppName = "NestingConfigObjects";
...
void ProcessCommand(char cmd)
{
    switch (toupper(cmd))
    {
        ...
        case 'L':
        {
            // Display and set the location for thermostats
            iprintf("Updating Thermostat 1\r\n");
            UpdateConfigString(thermoGroup.thermo_1.m_location);
            iprintf("Updating Thermostat 2\r\n");
            UpdateConfigString(thermoGroup.thermo_2.m_location);
            break;
        }
        ...
        case 'M':
        {
            ...
            iprintf("Updating Thermostat 1\r\n");
            UpdateConfigInt(thermoGroup.thermo_1.m_maxTemp);
            iprintf("Updating Thermostat 2\r\n");
            UpdateConfigInt(thermoGroup.thermo_2.m_maxTemp);
            break;
        }
        ...
        case 'N':
        {
            ...
            iprintf("Updating Thermostat 1\r\n");
            UpdateConfigInt(thermoGroup.thermo_1.m_minTemp);
            iprintf("Updating Thermostat 2\r\n");
            UpdateConfigInt(thermoGroup.thermo_2.m_minTemp);
            break;
        }
        ...
        case 'S':
        {
            ...
            iprintf("Updating Thermostat 1\r\n");
            UpdateConfigInt(thermoGroup.thermo_1.m_setTemp);
            iprintf("Updating Thermostat 2\r\n");
            UpdateConfigInt(thermoGroup.thermo_2.m_setTemp);
            break;
        }

        case 'T':
        {
            iprintf("Thermostat 1 Temp Records:\r\n");
            iprintf("     Temp Record 1: %d\r\n", int(thermoGroup.thermo_1.m_tempRec1));
            iprintf("     Temp Record 2: %d\r\n", int(thermoGroup.thermo_1.m_tempRec2));
            iprintf("Thermostat 2 Temp Records:\r\n");
            iprintf("     Temp Record 1: %d\r\n", int(thermoGroup.thermo_2.m_tempRec1));
            iprintf("     Temp Record 2: %d\r\n", int(thermoGroup.thermo_2.m_tempRec2));
            break;
        }
