...
#if ( defined NANO54415 || defined MOD5441X || defined SB800EX  )
#include "mcf5441x_rtc.h"
#elif (!defined PK70 && !defined SB70LC && !defined CB34EX && !defined NANO54415 && !defined MOD5441X && !defined MODM7AE70)
#include "rtc.h"
#endif
...
#if ( defined NANO54415 || defined MOD5441X || defined SB800EX  )
   int n = MCF541X_RTCSetSystemFromRTCTime();
#elif (!defined PK70 && !defined SB70LC && !defined CB34EX && !defined NANO54415 && !defined MOD5441X && !defined MODM7AE70)
    int n = RTCSetSystemFromRTCTime();
#else
    int n = 1;
#endif
    if (n == 0) { iprintf("Set system time from RTC\r\n"); }
    else
    {
