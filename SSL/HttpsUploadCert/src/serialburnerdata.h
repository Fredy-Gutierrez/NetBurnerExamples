 ...
 ******************************************************************************
 */
#define SERIAL_BURNER_CERTIFICATE_SIZE_MAX ((2 * 1024) - 1)
#define SERIAL_BURNER_CERTIFICATE_SIZE_MAX_PEM ((3 * 1024) - 1)
...
/* Get saved data */
extern BOOL UserGetData(char *dataPtr, char *fileName, int dataSize);
